...
Entrada: JMP Programa
   ...
   MOV AH, (VAR1+1*2)
   CMP AL, AH 
   JE sinaisIguais; Jump if equals, se os sinais são iguais manda para sinaisIguais 
   JNE sinaisDiferentes; Jump if not equals, se são diferentes manda para sinaisDiferentes
...
Programa ENDP
   ...
   SUBI proc near
     ...
     ME:
      SUB BL,CL ; subitrai de forma normal
      MOV AL,BL
      MOV AH,0
      AAM
      OR AX,3030H
